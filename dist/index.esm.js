...
function useChiaTransactions(client, unspentCoins) {
    ...
    const validateChiaAddress = useCallback((address) => {
        try {
            if (!address || typeof address !== 'string') {
    ...
    const selectCoinsForAmount = useCallback((totalNeededMojos) => {
    ...
    const sendXCH = useCallback(async (recipientAddress, amountXCH, feeXCH = 0.00001) => {
        if (!client) {
...
const ChiaWalletModal = ({ isOpen, onClose, wallet, }) => {
    ...
    return (jsxs(Fragment, { children: [jsx("div", { className: "modal-overlay", onClick: handleOverlayClick, onKeyDown: handleKeyDown, role: "dialog", "aria-modal": "true", tabIndex: 0, children: jsxs("div", { className: "modal-content", role: "document", tabIndex: 0, children: [jsxs("div", { className: "modal-header", children: [jsxs("div", { className: "wallet-info", children: [jsx("div", { className: "wallet-icon", children: jsx("div", { className: "chia-logo", children: "\uD83C\uDF31" }) }), jsxs("div", { className: "wallet-details", children: [jsx("h3", { children: wallet.publicKey ? wallet.formatAddress(wallet.publicKey) : 'Chia Wallet' }), jsx("p", { className: "connection-status", children: wallet.isConnecting ? 'Connecting...' :
                                                        wallet.isConnected ? 'Connected' : 'Not connected' })] })] }), jsx("button", { className: "close-btn", onClick: onClose, "aria-label": "Close modal", children: jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }), jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })] }) })] }), jsx("div", { className: "modal-body", children: wallet.isConnecting ? (jsxs("div", { className: "loading-state", children: [jsx("div", { className: "spinner" }), jsx("p", { children: "Connecting to wallet..." })] })) : wallet.error ? (jsxs("div", { className: "error-state", children: [jsx("p", { className: "error-message", children: wallet.error }), jsx("button", { className: "retry-btn", onClick: wallet.connectWallet, children: "Retry" })] })) : wallet.isConnected ? (jsxs("div", { className: "wallet-info-section", children: [jsx("div", { className: "balance-section", children: jsxs("div", { className: "balance-item", children: [jsx("div", { className: "balance-icon", children: "\uD83C\uDF31" }), jsxs("div", { className: "balance-details", children: [jsx("h4", { children: "Chia (XCH)" }), wallet.balanceLoading ? (jsxs("div", { className: "balance-loading", children: [jsx("div", { className: "balance-spinner" }), jsx("p", { className: "balance-amount syncing", children: "Syncing..." })] })) : wallet.balanceError ? (jsxs("div", { className: "balance-error", children: [jsx("p", { className: "balance-amount error", children: "Failed to load" }), jsx("button", { className: "balance-retry", onClick: wallet.refreshWallet, children: "Retry" })] })) : (jsxs(Fragment, { children: [jsxs("p", { className: "balance-amount", children: [wallet.formatBalance(wallet.balance), " XCH"] }), jsxs("p", { className: "balance-subtitle", children: [wallet.coinCount, " coins"] })] }))] })] }) }), jsxs("div", { className: "action-buttons", children: [jsxs("button", { className: "action-btn primary", children: [jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [jsx("line", { x1: "7", y1: "17", x2: "17", y2: "7" }), jsx("polyline", { points: "7,7 17,7 17,17" })] }), "Send"] }), jsxs("button", { className: "action-btn secondary", children: [jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [jsx("line", { x1: "17", y1: "7", x2: "7", y2: "17" }), jsx("polyline", { points: "17,17 7,17 7,7" })] }), "Receive"] })] }), jsxs("button", { className: "disconnect-btn", onClick: wallet.disconnectWallet, children: [jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [jsx("path", { d: "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" }), jsx("polyline", { points: "16,17 21,12 16,7" }), jsx("line", { x1: "21", y1: "12", x2: "9", y2: "12" })] }), jsx("span", { children: "Disconnect Wallet" })] })] })) : (jsxs("div", { className: "connect-state", children: [jsx("p", { children: "Connect your Chia wallet to get started" }), jsx("button", { className: "connect-btn", onClick: wallet.connectWallet, children: "Connect Wallet" })] })) })] }) }), jsx("style", { children: `
        .modal-overlay {
          position: fixed;
          top: 0;
          left: 0;
...
const ChiaWalletButton = ({ jwtToken = null, variant = 'primary', size = 'medium', disabled = false, baseUrl, enableLogging, autoConnect = true, onWalletUpdate, className = '', style, }) => {
    ...
    return (jsxs(Fragment, { children: [jsx("button", { className: getButtonClasses(), onClick: openModal, disabled: disabled, "aria-label": "Open Chia wallet", style: style, children: jsxs("div", { className: "btn-content", children: [jsx("div", { className: "chia-icon", children: "\uD83C\uDF31" }), jsx("div", { className: "btn-text-content", children: wallet.isConnecting ? (jsx("span", { className: "btn-text", children: "Connecting..." })) : wallet.isConnected && wallet.publicKey ? (jsxs(Fragment, { children: [jsx("span", { className: "btn-text connected-text", children: formatAddress(wallet.publicKey) }), wallet.balance > 0 ? (jsxs("span", { className: "btn-balance", children: [formatBalance(wallet.balance), " XCH"] })) : (jsx("span", { className: "btn-balance", children: "Click to view balance" }))] })) : (jsx("span", { className: "btn-text", children: jwtToken ? 'Chia Wallet' : 'Connect Chia' })) })] }) }), jsx(ChiaWalletModal, { isOpen: isModalOpen, onClose: closeModal, wallet: wallet }), jsx("style", { children: `
        .chia-wallet-btn {
          display: inline-flex;
          align-items: center;
          justify-content: center;
...
export { ChiaCloudWalletApiError, ChiaCloudWalletClient, ChiaWalletButton, ChiaWalletModal, chiaCloudWalletClient, normalizeCoin, normalizeCoins, useChiaTransactions, useChiaWallet };
