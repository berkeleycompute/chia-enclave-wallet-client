...
import { PiMagnifyingGlass, PiArrowsClockwise, PiCaretDown } from 'react-icons/pi';
        ...
        {!isConnected ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              {showCoinsDetails && (
                <div className="rounded-lg flex flex-col gap-3" style={{ backgroundColor: '#1B1C22', padding: '14px' }}>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <PiArrowsClockwise size={16} onMouseEnter={(e) => e.currentTarget.style.color = '#6bc36b'} onMouseLeave={(e) => e.currentTarget.style.color = '#7C7A85'}
                    onClick={() => { if (!metadataLoading) refreshNFTs(); }}
                    style={{ color: metadataLoading ? '#888' : '#7C7A85', cursor: metadataLoading ? 'not-allowed' : 'pointer', animation: metadataLoading ? 'spin 1s linear infinite' : 'none' }}
                  />
                </div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    style={{ paddingLeft: '40px', backgroundColor: '#1B1C22', borderColor: '#272830', color: '#A7A7A7' }}
